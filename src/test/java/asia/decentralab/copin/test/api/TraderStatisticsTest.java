...
//                "Win streak", account);
//
//        assertInRange(expected.loseStreak, 0, 1_000, "loseStreak");
...
//        assertLabels(expected.realisedStatisticLabels, expectedRealisedLabels, account);
//
//        List<String> expectedLabels = (List<String>) actual.get("statisticLabels");
//        assertLabels(expected.statisticLabels, expectedLabels, account);
    }

    private void assertLabels(List<String> expected, List<String> actual, String account) {
